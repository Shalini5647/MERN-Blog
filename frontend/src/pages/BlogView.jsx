      ...
      <div className="max-w-6xl mx-auto p-10">
        ...
        <div className="my-8">
          ...
          <div className="flex items-center justify-between flex-wrap gap-4">
            ...
            <div className="text-sm text-muted-foreground">
  Published {getRelativeTime(selectedBlog.createdAt)}
</div>
...
{selectedBlog?.thumbnail ? (
  <div className="mb-8 rounded-lg overflow-hidden">
    <img
      src={selectedBlog.thumbnail}
      alt={selectedBlog?.title || "GST Funda Blog Thumbnail"}
      width={1000}
      height={500}
      className="w-full object-cover"
    />
    ...
    {selectedBlog.subtitle}
        ...
        <div className="mt-10">
          <div className="flex flex-wrap gap-2 mb-8">
            ...
            <Badge variant="secondary">Real Estate Taxation</Badge>
            <Badge variant="secondary">Income Tax</Badge>
            <Badge variant="secondary">Rental Income</Badge>
            <Badge variant="secondary">Under-Construction Property</Badge>
            <Badge variant="secondary">Affordable Housing</Badge>
            <Badge variant="secondary">Home Loans</Badge>
            <Badge variant="secondary">TDS</Badge>
            <Badge variant="secondary">GST Registration</Badge>
            <Badge variant="secondary">Property Sale</Badge>
            <Badge variant="secondary">Investment Planning</Badge>
          </div>
