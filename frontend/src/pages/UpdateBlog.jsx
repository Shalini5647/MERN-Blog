            ...
            >
              ...
              <SelectContent>
                <SelectGroup>
                  ...
                  <SelectItem value="GST Rates">GST Rates</SelectItem>
                  <SelectItem value="Input Tax Credit">
                    Input Tax Credit
                  </SelectItem>
                  <SelectItem value="E-Invoicing">E-Invoicing</SelectItem>
                  <SelectItem value="Real Estate & GST">
                    Real Estate & GST
                  </SelectItem>
                  <SelectItem value="Rental Income & Tax">
                    Rental Income & Tax
                  </SelectItem>
                  <SelectItem value="TDS & TCS">TDS & TCS</SelectItem>
                  <SelectItem value="Income Tax">Income Tax</SelectItem>
                  <SelectItem value="Business Tax Compliance">
                    Business Tax Compliance
                  </SelectItem>
                  <SelectItem value="Tax Saving Strategies">
                    Tax Saving Strategies
                  </SelectItem>
                  <SelectItem value="GST News & Updates">
                    GST News & Updates
                  </SelectItem>
                </SelectGroup>
              </SelectContent>
