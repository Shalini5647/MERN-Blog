          ...
          <div>
            ...
            <div className="flex flex-col gap-2 items-start justify-start my-5">
              ...
              <p className="border dark:border-gray-600 p-6  rounded-lg">
                {user?.bio ||
                  "Written by a frontend enthusiast and tech blogger behind GST Funda's Tech Funda — sharing insights on web development, coding tutorials, and personal experiences from the developer's journey."}
              </p>
            </div>
